...
public class SharePrefNotesRepo implements NotesRepository{

    private static final String KEY_SAVED_NOTES = "KEY_SAVED_NOTES";

    private SharedPreferences sharedPreferences;

    public SharePrefNotesRepo(Context context) {
    ...
    public void getAll(Callback<List<Note>> callback) {
        ...
        Gson gson = new Gson();  // библиотека позволяет конвертировать объекты JSON в Java-объекты и наоборот.
